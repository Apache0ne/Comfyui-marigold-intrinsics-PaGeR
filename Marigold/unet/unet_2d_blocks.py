...
import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.getcwd(), "../resnet")))
from Marigold.resnet.resnet import ResnetBlock2D, ResnetBlockCondNorm2D
from Marigold.resnet.downsampling import Downsample2D, FirDownsample2D, KDownsample2D
from Marigold.resnet.upsampling import Upsample2D, FirUpsample2D, KUpsample2D
sys.path.append(os.path.abspath(os.path.join(os.getcwd(), "../unet")))
from Marigold.unet.attention_processor import Attention, AttnAddedKVProcessor, AttnAddedKVProcessor2_0

from diffusers.models.transformers.dual_transformer_2d import DualTransformer2DModel

from Marigold.unet.transformer_2d import Transformer2DModel
...
class KAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        if self.add_self_attention:
            ...
            hidden_states = rearrange(hidden_states, 'b c (h w t) -> (b t) c h w', t=6, h=h, w=w)
            norm_hidden_states = rearrange(norm_hidden_states, 'b c (h w t) -> (b t) c h w', t=6, h=h, w=w)
